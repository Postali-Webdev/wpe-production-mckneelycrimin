...
?>
	...
	<div class="PA_header"><div class="container_inner"><?php if ( function_exists('yoast_breadcrumb') ) {yoast_breadcrumb('<p id="breadcrumbs">','</p>');} ?><h1><?php single_cat_title(''); ?></h1></div></div>
