...
?>
	...
	<div class="PA_header"><div class="container_inner"><?php if ( function_exists('yoast_breadcrumb') ) {yoast_breadcrumb('<p id="breadcrumbs">','</p>');} ?><h1>Case Results</h1></div></div>
									...
									<article <?php if ( !has_post_thumbnail() ) { echo "class='no_image'"; } ?>>
										...
										<div class="post_text_holder">
											<div class="post_text_inner">
												...
												<span class="create"><span class="published">Published <?php _e('in','qode'); ?> <span class="category"><?php the_category(', '); ?></span></span></span>
												<?php the_excerpt(); ?>
												<span class="info">
