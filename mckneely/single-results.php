...
<?php while (have_posts()) : the_post(); ?>
                ...
                <div class="PA_header"><div class="container_inner"><?php if ( function_exists('yoast_breadcrumb') ) {yoast_breadcrumb('<p id="breadcrumbs">','</p>');} ?><h1>
						...
						<div class="blog_single_holder">
							<article>
								...
								<div class="blog_title_holder">
									 ...
									 <h2><?php the_title(); ?></h2>
									 <?php } ?>
									 <span><?php the_time('M d, Y'); ?> <?php _e('by','qode'); ?> <span class="blog_author"><?php the_author(); ?></span> <?php _e('in','qode'); ?> <span class="category"><?php the_category(', '); ?></span></span>
								</div>
