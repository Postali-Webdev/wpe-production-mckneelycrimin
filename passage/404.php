...
<?php get_header(); ?>
<div style="background-color: #1c2535; margin-top: 70px; padding-top:20px; height: 150px;"><div style="position:relative;" class="container_inner"><div class="logo"><a href="<?php echo home_url(); ?>/"><img src="<?php echo $qode_options_passage['logo_image']; ?>" alt="Logo"/></a></div>
                <!-- new phone widget -->
                    <div class="header_phone_widget"><?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('Header-Phone') ) : ?><?php endif; ?></div></div></div>
